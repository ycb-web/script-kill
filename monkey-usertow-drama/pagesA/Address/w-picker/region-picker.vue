...
<script>
	import areaData from "./areadata/areadatatow.js"
	...
	export default {
		...
		created() {
			...
			// console.log(typeof JSON.parse(uni.getStorageSync('city')));
			// this.areaData = Array.from(JSON.parse(uni.getStorageSync('city')))
			// console.log(this.areaData,'this.areaDatathis.areaData');
			this.initData();
		},
		methods:{
			getData(){
